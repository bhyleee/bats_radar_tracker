...
NORMALIZER_PATH = MODELS_DIR.joinpath('normalizer')
# Load the saved normalizer model
normalizer_model = tf.keras.models.load_model(NORMALIZER_PATH)
# The normalizer can now be used as before
normalizer = normalizer_model.layers[0]  # Extract the normalizer layer
